...
plutil -insert ProgramArguments.0 -string "$DESTINATION/Contents/MacOS/macos-ui-bridge" "$LAUNCH_AGENT"
plutil -insert ProgramArguments.1 -string app "$LAUNCH_AGENT"
