# 实现 WorkBuddy Cursor 真实写入闭环 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-14-workbuddy-cursor-24d76f05` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `yes` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title '实现 WorkBuddy Cursor 真实写入闭环' --long-running . |
| Budget | standard |
