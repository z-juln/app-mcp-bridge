# 实现 macOS 通用 UI Bridge 第一轮 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-10-macos-ui-bridge-96db7c45` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `yes` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title '实现 macOS 通用 UI Bridge 第一轮' --long-running '<target>' |
| Budget | complex |
...
| Confirmation ID | HRC-202607140215 |
| Confirmed At | 2026-07-14 02:15 |
