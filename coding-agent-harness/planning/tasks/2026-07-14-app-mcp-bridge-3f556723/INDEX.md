...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-14-app-mcp-bridge-3f556723` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `yes` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title '统一 App MCP Bridge 内部名称' --long-running . |
| Budget | standard |
...
| Review Commit SHA | 4bd993cd59b5ee3236d05011e4fd9ea49b79586f |
