...
当前通用 Skill 位于仓库的 `skills/macos-ui-control/`，构建后也会完整复制到
`/Applications/UI Bridge.app/Contents/Resources/skills/macos-ui-control`。用户可在设置的
...
先备份再更新。安装后重新读取 SKILL.md，核对名称，并告诉我安装位置和结果。
